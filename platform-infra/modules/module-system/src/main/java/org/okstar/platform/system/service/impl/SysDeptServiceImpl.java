...
import org.okstar.platform.system.mapper.SysDeptMapper;
import org.okstar.platform.system.mapper.SysRoleMapper;
import org.okstar.platform.system.service.ISysDeptService;
...
//    @Inject
    ...
    public int updateDept(SysDept dept)
    {
        ...
        if (UserConstants.DEPT_NORMAL.equals(dept.getStatus()) && OkStringUtil.isNotEmpty(dept.getAncestors())
                && !OkStringUtil.equals("0", dept.getAncestors()))
        {
